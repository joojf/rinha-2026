...
- haproxy lts-alpine como LB (round-robin), comunica com APIs via Unix sockets
- Limites somam ≤ 1.0 CPU e ≤ 350 MB
- `cpu_period=10ms` por container reduz throttle worst-case do cgroup pra 5.5ms

## Stack

Rust nightly + monoio (runtime io_uring single-thread) + haproxy + AVX2/FMA pra busca k-NN exata.
